...
//  Nearby
//
//  Created by Wagner Lemos Ferreira da Luz on 13/12/24.
//
...
class DetailsViewController: UIViewController {
    ...
    private func setupConstraints() {
        ...
        applyLateralConstaints(to: descriptionLabel)
        applyLateralConstaints(to: infoStackView)
        applyLateralConstaints(to: divider)
        applyLateralConstaints(to: divider2)
        applyLateralConstaints(to: regulationTitleLabel)
        applyLateralConstaints(to: regulationLabel)
        applyLateralConstaints(to: couponStackView)
        applyLateralConstaints(to: qrCodeButton)
    }
    
    private func applyLateralConstaints(to view: UIView) {
